        ...
        <div class="col-lg-3">
            <div class="UserBlock d-flex flex-column justify-content-between ">
                <div class="UserBlock__user">
                    ...
                    <div class="w-100"></div>
                    <span class="UserBlock__user__numberContract">Договор №{{ $renter->contract_number }}</span>
                </div>
                <div class="UserBlock__money">
                    <span class="UserBlock__money__textPayOut">К выдаче: 3990 <i class="UserBlock__money__icon fas fa-ruble-sign"></i></span>
                    <a href="#" class="UserBlock__money__link">
                        <div class="UserBlock__money__link__btnTake">Получить</div>
                    </a>
                </div>
            </div>
            <div class="w-100"></div>
            <div class="DateBlock">
                ...
                <div class="w-100"></div>
                <span class="DateBlock__dateEnding">20.06.2018</span>
